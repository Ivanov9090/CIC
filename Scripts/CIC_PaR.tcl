...
#  Created on Fri Nov 27 18:29:27 2020                
#                                                     
#######################################################
...
set fp_core_height 694.400000
set fp_core_to_bottom 10.080000
set fp_core_to_left 10.080000
set fp_core_to_right 10.080000
set fp_core_to_top 10.080000
set fp_core_width 698.345000
...
set init_verilog ../Outputs/CIC_synth.v
...
timeDesign -prePlace -idealClock -pathReports -drvReports -slackReports -numPaths 50 -prefix CIC_prePlace -outDir timingReports1
# Place Standard Cells
setPlaceMode -fp false
placeDesign -inPlaceOpt
#Create PreCTS setup Timing Report
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -preCTS -idealClock -pathReports -drvReports -slackReports -numPaths 50 -prefix CIC_preCTS -outDir timingReports1
#Create PreCTS hold Timing Report
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -preCTS -hold -idealClock -pathReports -slackReports -numPaths 50 -prefix CIC_preCTS -outDir timingReports1
#PreCTS Optimization
...
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postCTS -pathReports -drvReports -slackReports -numPaths 50 -prefix CIC_postCTS -outDir timingReports1
#Create PostCTS hold Timing Report
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postCTS -hold -pathReports -slackReports -numPaths 50 -prefix CIC_postCTS -outDir timingReports1
...
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix CIC_postRoute -outDir timingReports1
#Create PostRoute hold Timing Report
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix CIC_postRoute -outDir timingReports1
#SignOff
getFillerMode -quiet
...
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -signoff -pathReports -drvReports -slackReports -numPaths 50 -prefix CIC_signOff -outDir timingReports1
#Create SignOff hold Timing Report
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -signoff -hold -pathReports -slackReports -numPaths 50 -prefix CIC_signOff -outDir timingReports1
#Verifications
setVerifyGeometryMode -area { 0 0 0 0 } -minWidth true -minSpacing true -minArea true -sameNet true -short true -overlap true -offRGrid false -offMGrid true -mergedMGridCheck true -minHole true -implantCheck true -minimumCut true -minStep true -viaEnclosure true -antenna false -insuffMetalOverlap true -pinInBlkg false -diffCellViol true -sameCellViol false -padFillerCellsOverlap true -routingBlkgPinOverlap true -routingCellBlkgOverlap true -regRoutingOnly false -stackedViasOnRegNet false -wireExt true -useNonDefaultSpacing false -maxWidth true -maxNonPrefLength -1 -error 1000
verifyGeometry
setVerifyGeometryMode -area { 0 0 0 0 }
verify_drc -report CIC.drc.rpt -limit 1000
...
#write outputs files
write_sdf ../Outputs/CIC.sdf
saveNetlist ../Outputs/CIC
getFillerMode -quiet
